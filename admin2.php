...
<body>
    <div class="admin-container">
        ...
        <div class="admin-table">
            ...
            <div class="search-container">
                ...
                <button class="search-button" id="searchButton"><i class="fas fa-search"></i> Search</button>
            </div>
            <button class="manage-btn" onclick="loadProducts()">Load Products</button>
        ...
        <div class="admin-table">
            ...
            <button class="manage-btn" onclick="loadCategories()">Load Categories</button>
    ...
    <script>
        ...
        function loadProducts(query = '') {
            ...
            tableBody.innerHTML = '<tr><td colspan="7" class="no-products">Loading products...</td></tr>';
        ...
        function loadCategories() {
            ...
            tableBody.innerHTML = '<tr><td colspan="3" class="no-categories">Loading categories...</td></tr>';
            closeBtn.style.display = 'inline-block';

            fetch('products.php?action=list_categories')
                .then(response => {
                    if (!response.ok) throw new Error(`HTTP error! Status: ${response.status}`);
                    return response.json();
                })
        ...
        function editCategory(category, button) {
            ...
            actionsCell.innerHTML = `
                <div class="inline-edit-buttons">
                    <button class="save-btn" onclick="saveCategoryEdit('${originalName}', this)">Save</button>
        ...
        function updateCategoryDropdown() {
            fetch('products.php?action=list_categories')
                ...
                .then(data => {
                    ...
                    editNewOption.value = 'new';
                    editNewOption.textContent = 'Add New Category';
                ...
                .catch(error => {
                    ...
                    showMessage('Failed to update category dropdown: ' + error.message, 'error');
                });
        }

        // Handle category dropdown change for main form
        document.getElementById('productCategory').addEventListener('change', (e) => {
            const newCategoryInput = document.getElementById('newCategoryInput');
            if (e.target.value === 'new') {
                newCategoryInput.classList.add('active');
                newCategoryInput.required = true;
            } else {
                newCategoryInput.classList.remove('active');
                newCategoryInput.required = false;
                newCategoryInput.value = '';
            }
        });

        // Handle category dropdown change for modal form
