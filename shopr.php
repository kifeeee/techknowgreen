...
<head>
    ...
    <style>
        /* Existing styles remain unchanged, updating modal styles */
        .product-grid {
            display: flex;
            flex-wrap: nowrap;
            gap: 15px;
...
<body>
    ...
    <div class="modal" id="cartModal">
        <div class="modal-content">
            ...
            <p id="cartTotal">Total: KSh 0.00</p>
    ...
    <section class="faqs">
        ...
        <div class="faq-item">
            <div class="faq-question">What types of solar solutions do you offer?</div>
            <div class="faq-answer">We provide a range of solar solutions including solar panels, inverters, and complete solar kits for residential and commercial applications, tailored to your energy needs.</div>
        </div>
        <div class="faq-item">
        ...
        <div class="faq-item">
            <div class="faq-question">Do you offer maintenance services for borehole systems?</div>
            <div class="faq-answer">Yes, we provide comprehensive maintenance and repair services for borehole systems to ensure optimal performance and longevity.</div>
        </div>
        <div class="faq-item">
        ...
        <div class="faq-item">
            <div class="faq-question">Can you customize water storage tanks?</div>
            <div class="faq-answer">Yes, we offer customized steel tanks and towers designed to meet specific capacity and site requirements.</div>
        </div>
    </section>
